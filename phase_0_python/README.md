...
Goal: Be able to write clean .py pipeline code.
    ...
    -2. Write a class Dataset with __init__, __repr__, __len__, __getitem__ that wraps a pandas DataFrame.        -3. Implement your own train_test_split using pure Python indices.
...
Build a CLI with argparse for python train.py --config config.json.
